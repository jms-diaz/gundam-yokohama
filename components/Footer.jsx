...
const Footer = () => {
  return (
    <div className="w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2">
      <div className="max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-4 border-b-2 border-gray-600 py-8 px-4">
        <div>
      ...
      <div className="flex flex-col max-w-[1400px] mx-auto justify-betweeen sm:flex-row text-center text-gray-500">
        <p className="py-4">
          2023 Gundam Factory Yokohama. Created by James Diaz
        </p>
